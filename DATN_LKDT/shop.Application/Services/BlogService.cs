...
namespace shop.Application.Services
{
    public class BlogService : IBlogService
    {
        ...
        public async Task<ApiResponse<Pagination<List<BlogEntity>>>> SearchAdminBlogs(string searchText, int page, double pageResults)
        {
            var pageCount = Math.Ceiling((await FindAdminBlogsBySearchText(searchText)).Count / pageResults);
        ...
        private async Task<List<BlogEntity>> FindAdminBlogsBySearchText(string searchText)
        {
