...
namespace shop.Application.ViewModels.RequestDTOs
{
    ...
    {
        [Required(ErrorMessage = "account code không được bỏ trống")]
        public string Code { get; set; } = string.Empty;
        [Required(ErrorMessage = "Tên tài khoản không được bỏ trống"), MinLength(6, ErrorMessage = "Tên tài khoản phải chứa ít nhất 6 ký tự"), StringLength(50, ErrorMessage = "Tên tài khoản không được dài quá 50 ký tự")]
